...
I am a Ph.D. candidate at the University of Minnesota Twin Cities, advised by [Prof. Ce Yang](https://bbe.umn.edu/people/ce-yang). My research focuses on computer vision and vision–language models, with applications in agriculture. I explore the use of large language models and agent systems for crop disease diagnosis, crop phenotyping, and intelligent decision support. My work aims to integrate advanced AI techniques with agricultural data to enhance precision farming and sustainable crop management.

## Education

- **2024S-present:** Ph.D. candidate, University of Minnesota
- **2021F-2024S:** M.Sc., Guangxi University
- **2016F-2020F:** B.E., Beijing Foresty University

## Research Interests

* **Computer Vision:**  image and point cloud segmentation, generative models (e.g., GANs),  and NeRF-based 3D scene representation
* **Vision–Language Models:** Large language models, multimodal agents, and image captioning models
